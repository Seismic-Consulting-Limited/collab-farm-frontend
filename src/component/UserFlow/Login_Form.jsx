...
<div>
<Input label='Password *' placeholder='input your password' onIconClick={() => setShowPassword(!showPassword)} icon={eyeSlash} type={showPassword ? 'text': 'password'} autoComplete='current-password' htmlFor='password' />
